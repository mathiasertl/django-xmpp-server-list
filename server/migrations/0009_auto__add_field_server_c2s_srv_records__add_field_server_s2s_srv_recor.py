...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.c2s_srv_records'
        db.add_column(u'server_server', 'c2s_srv_records',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.s2s_srv_records'
        db.add_column(u'server_server', 's2s_srv_records',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.ipv6'
        db.add_column(u'server_server', 'ipv6',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.c2s_srv_records'
        db.delete_column(u'server_server', 'c2s_srv_records')

        # Deleting field 'Server.s2s_srv_records'
        db.delete_column(u'server_server', 's2s_srv_records')

        # Deleting field 'Server.ipv6'
        db.delete_column(u'server_server', 'ipv6')
