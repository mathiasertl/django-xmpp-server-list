...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Server.last_seen'
        db.alter_column(u'server_server', 'last_seen', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Server.last_seen'
        db.alter_column(u'server_server', 'last_seen', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 9, 14, 0, 0)))
    ...
    models = {
        ...
        u'server.server': {
            ...
            'last_seen': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
