...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CertificateAuthority.certificate'
        db.alter_column(u'server_certificateauthority', 'certificate', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='core/static/certs', null=True))

    def backwards(self, orm):

        # Changing field 'CertificateAuthority.certificate'
        db.alter_column(u'server_certificateauthority', 'certificate', self.gf('django.db.models.fields.FilePathField')(path='static/certs', max_length=100, null=True))
    ...
    models = {
        ...
        u'server.certificateauthority': {
            ...
            'certificate': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'core/static/certs'", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'server.logentry': {
            ...
            'server': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': u"orm['server.Server']"})
        },
        u'server.server': {
