...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogEntry.level'
        db.add_column(u'server_logentry', 'level',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogEntry.level'
        db.delete_column(u'server_logentry', 'level')
