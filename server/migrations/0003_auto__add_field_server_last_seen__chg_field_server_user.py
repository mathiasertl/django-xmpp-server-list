...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.last_seen'
        db.add_column(u'server_server', 'last_seen',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 9, 8, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Server.user'
        db.alter_column(u'server_server', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.LocalUser']))

    def backwards(self, orm):
        # Deleting field 'Server.last_seen'
        db.delete_column(u'server_server', 'last_seen')


        # Changing field 'Server.user'
        db.alter_column(u'server_server', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
