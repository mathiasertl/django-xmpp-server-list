...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.s2s_starttls'
        db.add_column(u'server_server', 's2s_starttls',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.s2s_starttls_required'
        db.add_column(u'server_server', 's2s_starttls_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.s2s_caps'
        db.add_column(u'server_server', 's2s_caps',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.s2s_starttls'
        db.delete_column(u'server_server', 's2s_starttls')

        # Deleting field 'Server.s2s_starttls_required'
        db.delete_column(u'server_server', 's2s_starttls_required')

        # Deleting field 'Server.s2s_caps'
        db.delete_column(u'server_server', 's2s_caps')
