...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.city'
        db.add_column(u'server_server', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Server.country'
        db.add_column(u'server_server', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.city'
        db.delete_column(u'server_server', 'city')

        # Deleting field 'Server.country'
        db.delete_column(u'server_server', 'country')
