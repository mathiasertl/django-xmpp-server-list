...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.c2s_tls_verified'
        db.add_column(u'server_server', 'c2s_tls_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Server.c2s_ssl_verified'
        db.add_column(u'server_server', 'c2s_ssl_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Server.s2s_tls_verified'
        db.add_column(u'server_server', 's2s_tls_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.c2s_tls_verified'
        db.delete_column(u'server_server', 'c2s_tls_verified')

        # Deleting field 'Server.c2s_ssl_verified'
        db.delete_column(u'server_server', 'c2s_ssl_verified')

        # Deleting field 'Server.s2s_tls_verified'
        db.delete_column(u'server_server', 's2s_tls_verified')
