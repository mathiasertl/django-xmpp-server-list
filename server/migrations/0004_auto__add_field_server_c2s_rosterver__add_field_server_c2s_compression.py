...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.c2s_rosterver'
        db.add_column(u'server_server', 'c2s_rosterver',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_compression'
        db.add_column(u'server_server', 'c2s_compression',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_starttls'
        db.add_column(u'server_server', 'c2s_starttls',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_starttls_required'
        db.add_column(u'server_server', 'c2s_starttls_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_register'
        db.add_column(u'server_server', 'c2s_register',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_sasl_auth'
        db.add_column(u'server_server', 'c2s_sasl_auth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Server.c2s_auth'
        db.add_column(u'server_server', 'c2s_auth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.c2s_rosterver'
        db.delete_column(u'server_server', 'c2s_rosterver')

        # Deleting field 'Server.c2s_compression'
        db.delete_column(u'server_server', 'c2s_compression')

        # Deleting field 'Server.c2s_starttls'
        db.delete_column(u'server_server', 'c2s_starttls')

        # Deleting field 'Server.c2s_starttls_required'
        db.delete_column(u'server_server', 'c2s_starttls_required')

        # Deleting field 'Server.c2s_register'
        db.delete_column(u'server_server', 'c2s_register')

        # Deleting field 'Server.c2s_sasl_auth'
        db.delete_column(u'server_server', 'c2s_sasl_auth')

        # Deleting field 'Server.c2s_auth'
        db.delete_column(u'server_server', 'c2s_auth')
    ...
    models = {
        ...
        u'server.server': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_seen': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
