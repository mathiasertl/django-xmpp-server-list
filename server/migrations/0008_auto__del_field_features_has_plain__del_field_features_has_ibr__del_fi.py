...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Features.has_plain'
        db.delete_column(u'server_features', 'has_plain')

        # Deleting field 'Features.has_ibr'
        db.delete_column(u'server_features', 'has_ibr')

        # Deleting field 'Features.has_tls'
        db.delete_column(u'server_features', 'has_tls')

        # Deleting field 'Features.has_ssl'
        db.delete_column(u'server_features', 'has_ssl')


    def backwards(self, orm):
        # Adding field 'Features.has_plain'
        db.add_column(u'server_features', 'has_plain',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Features.has_ibr'
        db.add_column(u'server_features', 'has_ibr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Features.has_tls'
        db.add_column(u'server_features', 'has_tls',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Features.has_ssl'
        db.add_column(u'server_features', 'has_ssl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'server.server': {
            ...
            'c2s_ssl_verified': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'c2s_tls_verified': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            's2s_tls_verified': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
