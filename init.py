...
from server.models import ServerSoftware
...
Server.objects.create(user=u, contact='fsinf@conference.fsinf.at', contact_type='M',
    features=Features.objects.create(), launched=today,
