...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserConfirmationKey.user'
        db.delete_column(u'confirm_userconfirmationkey', 'user_id')

        # Adding field 'UserConfirmationKey.subject'
        db.add_column(u'confirm_userconfirmationkey', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='confirmations', to=orm['account.LocalUser']),
                      keep_default=False)

        # Deleting field 'ServerConfirmationKey.server'
        db.delete_column(u'confirm_serverconfirmationkey', 'server_id')

        # Adding field 'ServerConfirmationKey.subject'
        db.add_column(u'confirm_serverconfirmationkey', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='confirmations', to=orm['server.Server']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserConfirmationKey.user'
        db.add_column(u'confirm_userconfirmationkey', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='confirmations', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'UserConfirmationKey.subject'
        db.delete_column(u'confirm_userconfirmationkey', 'subject_id')

        # Adding field 'ServerConfirmationKey.server'
        db.add_column(u'confirm_serverconfirmationkey', 'server',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='confirmations', to=orm['server.Server']),
                      keep_default=False)

        # Deleting field 'ServerConfirmationKey.subject'
        db.delete_column(u'confirm_serverconfirmationkey', 'subject_id')
    ...
    models = {
        ...
        u'confirm.serverconfirmationkey': {
            ...
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'confirmations'", 'to': u"orm['server.Server']"}),
        ...
        u'confirm.userconfirmationkey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'confirmations'", 'to': u"orm['account.LocalUser']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
