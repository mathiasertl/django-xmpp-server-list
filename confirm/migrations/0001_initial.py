...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'confirm_userconfirmationkey', (
            ...
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='confirmations', to=orm['account.LocalUser'])),
        ))
        ...
        db.create_table(u'confirm_userpasswordresetkey', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='password_resets', to=orm['account.LocalUser'])),
        ))
        ...
        db.create_table(u'confirm_serverconfirmationkey', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='confirmations', to=orm['server.Server'])),
        ))
    ...
    models = {
        ...
        u'confirm.userpasswordresetkey': {
            'Meta': {'object_name': 'UserPasswordResetKey'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'password_resets'", 'to': u"orm['account.LocalUser']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
