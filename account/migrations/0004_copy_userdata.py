...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for profile in orm['account.UserProfile'].objects.all():
            user = orm['account.LocalUser'].objects.get(id=profile.user_id)
    ...
    def backwards(self, orm):
        ...
        for user in orm['account.LocalUser'].objects.all():
            orm['account.UserProfile'].objects.create(
                user=user,
                jid=user.jid,
                email_confirmed=user.email_confirmed,
                jid_confirmed=user.jid_confirmed,
            )
